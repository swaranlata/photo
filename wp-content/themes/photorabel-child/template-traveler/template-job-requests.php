<?php
/* Template Name: Traveler Job Requests with Login */
get_header('custom');
unsetSession('hireType');
$userId=get_custom_user_id();
$url=site_url().'/api/getMyJobRequests.php?userId='.$userId;
                            ...
                            if($vv['requestStatus']=='5'){
                              ...
                              echo getStatus($vv['requestStatus']);   
								...
								<td>
									<div class="tabCon">
										<h3>action</h3>
										<a href="<?php echo home_url().'/view-job-detail/'.$vv['requestId']; ?>" class="custom-btn btn-blue">View Details</a>
									</div>
								</td>
							</tr>
							<?php
